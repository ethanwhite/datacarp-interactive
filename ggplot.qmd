...
1. Make a scatter plot with `hp` on the x axis and `wt` on the y axis. Label the x axis "Horse Power" and the y axis “Weight”.
2. Modify the code to make 1 subplot for each value in `gear`.
